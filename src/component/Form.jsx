              ...
              <form onSubmit={this.handleSubmit}>
                <div className="grey-text">
                  <MDBInput
                    ...
                    error="wrong"
                    success="right"
                    name ="firstName" value={this.state.firstName} className ="name" onChange={this.handleChange}
                  />
                  <MDBInput
                    label="Lastname"
                    icon="user-alt"
                    ...
                    error="wrong"
                    success="right"
                    name ="lastName" value={this.state.lastName} className ="name" onChange={this.handleChange}
                  />
                  <MDBInput
                    label="Email"
                    icon="envelope"
                    ...
                    error="wrong"
                    success="right"
                    name ="email" value={this.state.email} className ="name" onChange={this.handleChange}
                  />
                  <MDBInput
                    label=" Phone Number"
                    icon="phone"
                  ...
                  <MDBInput
                    ...
                    error="wrong"
                    success="right"
                    name ="workmanship" value={this.state.workmanship} className ="name" onChange={this.handleChange}
                  />
                   <MDBInput
                    label="Total Cost"
                    ...
                    error="wrong"
                    success="right"
                    name ="total" value={this.state.total} className ="name" onChange={this.handleChange}
                  />
                </div>
